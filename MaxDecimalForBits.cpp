...
void GetMaxNumberForBits(int numOfBits) {
    ...
    //This returns the total number of both POSITIVE and NEGATIVE numbers.
    for (int i = (numOfBits - 1); i >= 0; i--) {
        valueReturn += std::pow(2,i);
    }
    //This changes the result to give the largest of either POSITIVE or NEGATIVE numbers
    valueReturn = valueReturn / 2;
